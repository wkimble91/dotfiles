...
weather = requests.get("https://wttr.in/Bellingham, Washington?format=j1").json()
...
current_temp = weather['current_condition'][0]['FeelsLikeF']
...
for i, day in enumerate(weather['weather']):
    ...
    data['tooltip'] += f"⬆High of {day['maxtempF']}° | ⬇Low of {day['mintempF']}°\n"
    data['tooltip'] += f"  Sunrise at {day['astronomy'][0]['sunrise']}\n  Sundown at {day['astronomy'][0]['sunset']}\n"
